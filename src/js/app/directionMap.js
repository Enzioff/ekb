        ...
        const IDLayout = ymaps.templateLayoutFactory.createClass(
            `
                <div style="position: relative; cursor:pointer;" class="placeMark" data-lat="${lat}" data-lan="${lan}">
                    ...
                    <div style="position: absolute; top: 0; left: 100%; display: flex; align-items: center; font-size: 10px; background-color: #FFFFFF; min-height: 30px; padding: 0 10px 0 25px; z-index: 0;">
                        <p>${description}</p>
                    </div>
                </div>
            `
